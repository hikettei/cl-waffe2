...
typedef __m128 waffe2_svech; // half precision

// double-float
typedef __m256d waffe2_dvec;
typedef __m128d waffe2_dvech; // half precision

// integers
typedef __m256i waffe2_ivec;
typedef __m128i waffe2_ivech; // half precision
...
waffe2_svec static inline waffe2_load_dvec(double* ptr) { return _mm256_loadu_pd(ptr); }
...
waffe2_svec static inline waffe2_load_dscal(double scal)  { return _mm256_set1_pd(scal); }
...
waffe2_svec static inline waffe2_simd_dadd(waffe2_dvec x, waffe2_dvec y) { return _mm256_add_pd(x, y); }
waffe2_svec static inline waffe2_simd_dsub(waffe2_dvec x, waffe2_dvec y) { return _mm256_sub_pd(x, y); }
waffe2_svec static inline waffe2_simd_dmul(waffe2_dvec x, waffe2_dvec y) { return _mm256_mul_pd(x, y); }
waffe2_svec static inline waffe2_simd_ddiv(waffe2_dvec x, waffe2_dvec y) { return _mm256_div_pd(x, y); }
