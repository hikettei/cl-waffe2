...
{CPUTENSOR[float] :shape (10 10) :id TID1948 
  :vec-state [computed]
...
{CPUTENSOR[float] :shape (10 10) :id TID2043 
  :vec-state [computed]
...
{CPUTENSOR[float] :shape (10 10) :id TID2130 
  :vec-state [computed]
...
{CPUTENSOR[float] :shape (10 10) :id TID2290 
  :vec-state [computed]
...
{CPUTENSOR[float] :shape (10 10) :id TID2385 
  :vec-state [computed]
...
{CPUTENSOR[float] :shape (3 3) :id TID2551 
  :vec-state [computed]
...
{CPUTENSOR[float] :shape (10 10) :id TID2690 
  :vec-state [computed]
...
{CPUTENSOR[float] :shape (10 10) :id TID2792 
  :vec-state [computed]
